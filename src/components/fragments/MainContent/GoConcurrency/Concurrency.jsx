    ...
    <div className='flex flex-col pb-3 lg:pt-5 lg:items-start lg:flex-row lg:gap-x-3 gap-y-7'>
      <div className='w-full'>
        <FillContent
          ...
          judul={'Concurrency vs Parallelism'}
          pengertian={'Concurrency: Ibarat Anda memiliki banyak pekerjaan yang harus dilakukan, seperti memasak, mencuci pakaian, dan membersihkan rumah. Anda tidak menyelesaikan semuanya sekaligus, tetapi Anda mengatur waktu untuk melakukan sedikit demi sedikit dari setiap tugas. Misalnya, Anda mulai memasak, kemudian ketika menunggu air mendidih, Anda mencuci pakaian, dan saat mesin cuci berputar, Anda mulai membersihkan rumah. Anda bergiliran antara tugas-tugas ini. Parallel Programming: Ibarat Anda menyewa beberapa orang untuk membantu menyelesaikan pekerjaan rumah. Satu orang memasak, satu orang mencuci pakaian, dan satu lagi membersihkan rumah secara bersamaan. Semua tugas berjalan secara bersamaan pada waktu yang sama.'}
