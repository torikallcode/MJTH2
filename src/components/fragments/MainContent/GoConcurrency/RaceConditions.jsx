    ...
    <div className='flex flex-col pb-3 lg:pt-5 lg:items-start lg:flex-row lg:gap-x-3 gap-y-7'>
      <div className='w-full'>
        <FillContent
          ...
          judul={'Race Conditions'}
          pengertian={' Race Condition:Bayangkan Anda sedang membuat pizza bersama beberapa teman. Anda semua bekerja di dapur yang sama, dan ada satu botol saus tomat yang kalian gunakan untuk topping pizza. Jika dua orang mencoba mengambil saus tomat pada waktu yang sama tanpa aturan yang jelas, bisa saja salah satu dari mereka tidak mendapatkan cukup saus atau tumpah karena kedua orang tersebut tidak tahu apa yang sedang dilakukan oleh yang lain. Ini disebut race condition—dua atau lebih proses mencoba mengakses sumber daya yang sama secara bersamaan tanpa koordinasi yang tepat, yang menyebabkan hasil yang tidak diharapkan.'}
