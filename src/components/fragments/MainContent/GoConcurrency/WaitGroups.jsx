    ...
    <div className='flex flex-col pb-3 lg:pt-5 lg:items-start lg:flex-row lg:gap-x-3 gap-y-7'>
      <div className='w-full'>
        <FillContent
          ...
          judul={'WaitGroup'}
          pengertian={'Wait Group: Bayangkan Anda adalah seorang manajer proyek, dan Anda memberi tugas kepada beberapa pekerja untuk menyelesaikan pekerjaan tertentu. Setiap pekerja akan mengerjakan bagiannya masing-masing secara paralel. Sebelum Anda bisa melanjutkan ke tahap berikutnya, Anda harus menunggu semua pekerja menyelesaikan tugas mereka. Anda menggunakan wait group sebagai daftar kehadiran di mana Anda menandai siapa yang sudah menyelesaikan pekerjaannya. Ketika semua pekerja sudah selesai, barulah Anda bisa melanjutkan ke langkah berikutnya.Contoh: Anda meminta tiga pekerja membersihkan ruangan yang berbeda. Anda tidak bisa mengunci kantor sampai semuanya selesai, jadi Anda menunggu mereka semua menyelesaikan pekerjaan sebelum melanjutkan.'}
