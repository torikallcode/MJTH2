    ...
    <div className='flex flex-col pb-3 lg:pt-5 lg:items-start lg:flex-row lg:gap-x-3 gap-y-7'>
      <div className='w-full'>
        <FillContent
          ...
          judul={'Atomic'}
          pengertian={'Atomic: Bayangkan ada sebuah kotak uang bersama di kantor, dan hanya satu orang yang boleh menambah atau mengambil uang pada suatu waktu. Jika seseorang ingin menambah uang ke dalam kotak, mereka harus melakukannya secara hati-hati dan tidak boleh ada orang lain yang melakukan transaksi pada saat yang sama. Operasi atomic ini memastikan bahwa satu transaksi (menambah atau mengambil uang) diselesaikan sepenuhnya sebelum orang lain bisa melakukan hal yang sama. Dalam pemrograman, operasi atomic memastikan bahwa operasi tertentu (seperti penambahan nilai) dilakukan sepenuhnya tanpa interupsi oleh goroutine lain, sehingga tidak ada konflik atau kesalahan data.'}
