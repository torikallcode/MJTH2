    ...
    <div className='flex flex-col pb-3 lg:pt-5 lg:items-start lg:flex-row lg:gap-x-3 gap-y-7'>
      <div className='w-full'>
        <FillContent
          ...
          judul={'Io'}
          pengertian={'Package io adalah bagian dari Go standard library yang digunakan untuk bekerja dengan input dan output di dalam program. Artinya, kita bisa membaca data dari sumber (input) dan menulis data ke tujuan (output), seperti file, jaringan, atau memori.'}
